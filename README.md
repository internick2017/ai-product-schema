# AI Product Schema for WooCommerce

**Published on WordPress.org:** https://wordpress.org/plugins/internick-ai-product-schema/

This is the maintained source of the plugin. The earlier history, from when the project was
called ShopGraph, lives in the archived
[internick-ai-product-schema](https://github.com/internick2017/internick-ai-product-schema)
repository.
...
The store is served by the local DDEV environment.
