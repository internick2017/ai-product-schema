	...
	public function get_settings_for_default_section(): array {
		return array(
			...
			array(
				...
				'desc'     => __( 'Auto enhances the Product schema WooCommerce (or Yoast / Rank Math) already outputs. Standalone suppresses those and prints AI Product Schema\'s own complete Product node instead. Neither mode ever outputs a duplicate.', 'internick-ai-product-schema' ),
